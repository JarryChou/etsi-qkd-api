...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.send_button.setGeometry(QtCore.QRect(680, 490, 89, 51))
        self.send_button.setObjectName("send_button")
        self.encrypted_chat_box = QtWidgets.QTextEdit(self.main_frame)
        self.encrypted_chat_box.setGeometry(QtCore.QRect(390, 30, 381, 451))
        self.encrypted_chat_box.setObjectName("encrypted_chat_box")
        self.label = QtWidgets.QLabel(self.main_frame)
        self.label.setGeometry(QtCore.QRect(140, 10, 111, 17))
        self.label.setObjectName("label")
        self.label_2 = QtWidgets.QLabel(self.main_frame)
        self.label_2.setGeometry(QtCore.QRect(530, 10, 111, 17))
